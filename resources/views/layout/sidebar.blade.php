...
<aside id="default-sidebar"
    class="fixed inset-y-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar">
    ...
    <div class="h-full  py-4 overflow-y-auto bg-gray-100 dark:bg-gray-800">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/"
                    class="flex items-center p-3 px-5 text-gray-900 rounded-lg group hover:bg-gray-100 transition-colors duration-200">
                    ...
                    <span class="ml-4 font-semibold">Warkop Tjemara</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('inventaris.index') }}"
                    ...
                    <span class="flex-1 ml-4 whitespace-nowrap">Data Inventaris</span>
                    {{-- <span
                        class="inline-flex items-center justify-center w-5 h-5 text-xs font-medium text-blue-800 bg-blue-100 border-2 border-white rounded-full dark:bg-blue-900 dark:text-blue-300">3</span> --}}
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('transaksi.index') }}"
                    ...
                    <span class="flex-1 ml-4 whitespace-nowrap">Data Transaksi</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('menu.index') }}"
                    ...
                    <span class="flex-1 ml-4 whitespace-nowrap">Menu</span>
                </a>
            </li>
        ...
        <a href="#"
            ...
            <span class="flex-1 ml-4 whitespace-nowrap">Sign In</span>
        </a>
    </li> --}}
